...
public sealed partial class WithStatementSyntax : StatementSyntax
{
    ...
    internal WithStatementSyntax(InternalSyntax.CSharpSyntaxNode green, SyntaxNode? parent, int position)
      : base(green, parent, position)
    {
    }
    ...
    public SyntaxToken WithKeyword => new SyntaxToken(this, ((InternalSyntax.WithStatementSyntax)this.Green).withKeyword, GetChildPosition(1), GetChildIndex(1));

    public SyntaxToken OpenParenToken => new SyntaxToken(this, ((InternalSyntax.WithStatementSyntax)this.Green).openParenToken, GetChildPosition(2), GetChildIndex(2));

    public ExpressionSyntax Value => GetRed(ref this.value, 3)!;

    public SyntaxToken CloseParenToken => new SyntaxToken(this, ((InternalSyntax.WithStatementSyntax)this.Green).closeParenToken, GetChildPosition(4), GetChildIndex(4));
    ...
    public override TResult? Accept<TResult>(CSharpSyntaxVisitor<TResult> visitor) where TResult : default => visitor.VisitWithStatement(this);

    public WithStatementSyntax Update(SyntaxList<AttributeListSyntax> attributeLists, SyntaxToken withKeyword, SyntaxToken openParenToken, ExpressionSyntax value, SyntaxToken closeParenToken, BlockSyntax block)
    {
    ...
    internal override StatementSyntax WithAttributeListsCore(SyntaxList<AttributeListSyntax> attributeLists) => WithAttributeLists(attributeLists);
    public new WithStatementSyntax WithAttributeLists(SyntaxList<AttributeListSyntax> attributeLists) => Update(attributeLists, this.WithKeyword, this.OpenParenToken, this.Value, this.CloseParenToken, this.Block);
    public WithStatementSyntax WithWithKeyword(SyntaxToken withKeyword) => Update(this.AttributeLists, withKeyword, this.OpenParenToken, this.Value, this.CloseParenToken, this.Block);
    public WithStatementSyntax WithOpenParenToken(SyntaxToken openParenToken) => Update(this.AttributeLists, this.WithKeyword, openParenToken, this.Value, this.CloseParenToken, this.Block);
    public WithStatementSyntax WithValue(ExpressionSyntax value) => Update(this.AttributeLists, this.WithKeyword, this.OpenParenToken, value, this.CloseParenToken, this.Block);
    public WithStatementSyntax WithCloseParenToken(SyntaxToken closeParenToken) => Update(this.AttributeLists, this.WithKeyword, this.OpenParenToken, this.Value, closeParenToken, this.Block);
    public WithStatementSyntax WithBlock(BlockSyntax block) => Update(this.AttributeLists, this.WithKeyword, this.OpenParenToken, this.Value, this.CloseParenToken, block);

    internal override StatementSyntax AddAttributeListsCore(params AttributeListSyntax[] items) => AddAttributeLists(items);
    public new WithStatementSyntax AddAttributeLists(params AttributeListSyntax[] items) => WithAttributeLists(this.AttributeLists.AddRange(items));
}
